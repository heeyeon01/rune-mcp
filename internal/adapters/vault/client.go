...
// buildDialOpts assembles the dial options shared by NewClient and NewRedeemer:
// message-size caps, keepalive, optional interceptors, and the TLS/CA selection
// (explicit CA pin > system bundle; TLSDisable is dev-only).
